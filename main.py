...
class Lamport:
    ...
    def sign(self, message, sk=[[0]*256]*2):
        signature = [0]*256

        # hash the message to get a unique hash sum
        message_hash = bin(int(hashlib.sha256(message.encode()).hexdigest(), 16))[2:]
    ...
    def verify(self, message, pk=[[0]*256]*2, signature=[0]*256):
